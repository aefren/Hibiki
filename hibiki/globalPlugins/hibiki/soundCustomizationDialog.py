...
CONTROL_DISPLAY_NAMES = {
    ...
    'heading1': _("Heading Level 1"),
    'heading2': _("Heading Level 2"),
    'heading3': _("Heading Level 3"),
    'heading4': _("Heading Level 4"),
    'heading5': _("Heading Level 5"),
    'heading6': _("Heading Level 6"),
    'document': _("Document"),
