...
controlTypes.ROLE_TOGGLEBUTTON : "togglebutton.wav",
...
controlTypes.ROLE_MENUBUTTON : "menubutton.wav",
...
class GlobalPlugin(globalPluginHandler.GlobalPlugin):
	...
	def play_object(self, obj):
		...
		if role in sounds:
			...
			sounds[role].play()
			if 256 in states:
				sounds["expanded"].set_position(position_x, position_y, AUDIO_DEPTH * -1)
				sounds["expanded"].play()
			if 512 in states:
				sounds["collapsed"].set_position(position_x, position_y, AUDIO_DEPTH * -1)
				sounds["collapsed"].play()
			if 2048 in states:
				sounds["visited_link"].set_position(position_x, position_y, AUDIO_DEPTH * -1)
				sounds["visited_link"].play()
			if 32 in states:
				sounds["checked"].set_position(position_x, position_y, AUDIO_DEPTH * -1)
				sounds["checked"].play()
